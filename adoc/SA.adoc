...
This Document will contain best practices and planning considerations when using SUSE's Automation templates for the SAP Landscape. 
The Document is targeted at Consultants and End-customers who are deploying SAP Landscapes in the public cloud.  
Guidance will be provided on how the Terraforms, SALT, and other components work together to provide consistent and validated architecture. 

The document can be used as a guide for a workshop to enable partners regarding the proper use of these tools.
