...
The structure is similar what you have seen above for pillars and states
...
So with help of the pillar data and the state file and the formular salt will create
all needed configuration on the node, installs HANA and if enabled install hana systemreplication and set up the pacemaker cluster, right for {cloud}.
