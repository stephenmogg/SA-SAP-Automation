...
It is targeted at consultants and end-customers deploying SAP Landscapes in the public cloud and provides guidance on how the Terraforms, SALT, and other components work together to provide a consistent and validated architecture. 
