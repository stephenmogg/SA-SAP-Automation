...
The solutions will get extended continuously depending on demands of customers and partners and in development is already Netweaver HA with ENSA2 ( Enqueue Standalone Architecture 2).

If you want to know more about the ENSA2 details please have a look at a blog of my colleagues https://www.suse.com/c/suse-ha-sap-certified

The overall landscape which get deployed look like this

image::SAP_Overview.png[Instance overview,width="80%"]
