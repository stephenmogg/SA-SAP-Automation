...
The project uses the needed building blocks to create this landscape within the top.sls file, depending on the role of the node, the needed actions are triggered.
