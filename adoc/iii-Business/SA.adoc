...
SAP architectures needs to be fine-tuned based on the customer’s requirement on system availability i.e 99.99% or 99.95% or 99.9%. So you need to identify the Single Point of Failures (SPOF) in the components and services. Such SPOF's then need to be in a HA cluster
