...
NOTE:: For more information about how to create a Google Cloud Storage Bucket, refer to https://cloud.google.com/storage/docs/creating-buckets
 ...
 * Adjustments for the Google Cloud Infrastructure
 * Handle Netweaver, HANA and DRBD
endif::[]
